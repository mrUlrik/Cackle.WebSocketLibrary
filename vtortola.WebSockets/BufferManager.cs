...
namespace vtortola.WebSockets
{
    public abstract class BufferManager
    {
        ...
        /// </summary>
        /// <param name="maxBufferPoolSize">The maximum size in bytes of the pool.</param>
        /// <param name="maxBufferSize">The maximum size in bytes of an individual buffer.</param>
        ...
        public static BufferManager CreateBufferManager(long maxBufferPoolSize, int maxBufferSize)
        {
            ...
            var smallPoolSizeLimit = (int)Math.Max(2, (maxBufferPoolSize - largePoolSizeLimit * largeBufferSize) / smallBufferSize); // take another half of maxMemory as small buffers
